...
extern uint8_t DS3231_US_Buf[7];	//时间日历数据缓存
extern uint8_t DS3231_Init_Buf[7];
/******************************************************************************
                                  参数宏定义                       
******************************************************************************/

//#define DS3231_YEARDATA                  (uint16_t)0x2018	//年结构，如果是19xx年、21xx年的话请修改这个数值即可
...
void DS3231_Time_Init(uint8_t *Time_ch);	//时间日历初始化
